    ...
    return (
        <div className='p-5 dark:border rounded-xl flex flex-wrap flex-row justify-between dark:bg-darkBg2  my-10'>
            ...
            <label htmlFor="" className='h-20 my-2 basis-full'>
                ...
                <input name="address" type="text" placeholder='Введіть адресу' className='rounded-full px-6 h-12 w-full shadow-lg dark:border-2 dark:bg-darkBg2 dark:border-darkBorder dark:text-darkText dark:focus:border-darkActive' {...register('address')} />
            </label>
