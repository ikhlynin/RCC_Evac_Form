...
const accommodationOptions = [{
    ...
    label: 'Є житло в інщій області',
    value: 'Є житло в інщій області'
}, {
    label: 'Потрібне поселення в інщій області (реєстрація на евак потяг)',
    value: 'Потрібне поселення в інщій області (реєстрація на евак потяг)'
}]
